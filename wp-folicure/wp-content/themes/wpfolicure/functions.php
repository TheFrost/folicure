<?php
  ...
  function theme_styles() {
    ...
    wp_enqueue_style( 'perfect-scroll', get_template_directory_uri() . '/css/perfect-scrollbar.min.css' );
  ...
  function theme_js() {
    ...
    wp_enqueue_script( 'perfect-scroll', get_template_directory_uri() . '/libs/perfect-scrollbar.jquery.min.js', array('jquery'), '', true );
